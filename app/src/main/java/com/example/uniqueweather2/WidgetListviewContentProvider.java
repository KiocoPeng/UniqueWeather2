...
import com.example.uniqueweather2.db.CountyChanged;

import org.litepal.LitePal;

public class WidgetListviewContentProvider extends ContentProvider {

    private static final String authority = "com.example.uniqueweather2.WidgetListviewContentProvider";
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        SQLiteDatabase db = SQLiteDatabase.openOrCreateDatabase("/data/data/com.example.uniqueweather2/databases/uniqueweather2.db", null);
        Cursor cursor = null;
    ...
    public String getType(Uri uri) {
        switch (uriMatcher.match(uri)) {
            case COUNTYCHANGED_DIR:
                return "vnd.android.cursor.dir/vnd.com.example.uniqueweather2.WidgetListviewContentProvider.CountyChanged";
            case COUNTYCHANGED_ITEM:
                return "vnd.android.cursor.item/vnd.com.example.uniqueweather2.WidgetListviewContentProvider.CountyChanged";
            default:
                break;
        }
        return null;
