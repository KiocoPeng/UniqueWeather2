package com.example.uniqueweather2.service;
...
import com.example.uniqueweather2.LogUtil;
import com.example.uniqueweather2.R;
import com.example.uniqueweather2.WidgetProvider;
import com.example.uniqueweather2.db.SelectedCounty;
import com.example.uniqueweather2.gson.HeWeather5;
import com.example.uniqueweather2.http.OkHttp;
import com.example.uniqueweather2.json.WeatherJson;
...
public class ListViewService extends RemoteViewsService {
    ...
    //获取和风天气的key--自己的
    public static final String KEY = "09f958eb24ab4d0da128a28cd7263a13";
    //获取和风天气的key--作者的
    ...
    private class ListRemoteViewsFactory implements RemoteViewsService.RemoteViewsFactory {
        ...
        private static final String U_COUNTYCHANGED = "content://com.example.uniqueweather2.WidgetListviewContentProvider/CountyChanged";
        private static final String U_SELECTEDCOUNTY = "content://com.example.uniqueweather2.WidgetListviewContentProvider/SelectedCounty";
...
//            String test2 = test.getString("weatherId", null);
    ...
    public void requestWeatherAsync(final String weateherId) {
        ...
        String weatherUrl = "https://free-api.heweather.net/s6/weather/hourly?location="
                + weateherId + "&key=" + KEY;
        OkHttp.sendRequestOkHttpForGet(weatherUrl, new okhttp3.Callback() {
            @Override
