...
import com.example.uniqueweather2.db.City;
import com.example.uniqueweather2.db.County;
import com.example.uniqueweather2.db.CountyChanged;
import com.example.uniqueweather2.db.Province;
import com.example.uniqueweather2.db.SelectedCounty;
import com.example.uniqueweather2.http.OkHttp;
import com.example.uniqueweather2.json.AreaJson;
...
//                    startActivity(intent);
    ...
    public void queryForService (String adress, final int typeLevel){
        OkHttp.sendRequestOkHttpForGet(adress, new okhttp3.Callback() {
            @Override
