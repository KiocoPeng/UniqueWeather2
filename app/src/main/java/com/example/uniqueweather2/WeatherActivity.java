package com.example.uniqueweather2;
...
import com.example.uniqueweather2.http.MyCallBack;
import com.example.uniqueweather2.http.MyHttp;
import com.example.uniqueweather2.http.OkHttp;
import com.example.uniqueweather2.json.WeatherJson;
import com.example.uniqueweather2.util.GsonUtils;
import com.example.uniqueweather2.util.LogUtils;
...
public class WeatherActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener {
    ...
    public void initView() {
        ...
        SharedPreferences prefs = getPreferences(WeatherActivity.MODE_PRIVATE);
...
//        }
    ...
    public void updateBingPic() {
        ...
        OkHttp.sendRequestOkHttpForGet(requestBingPic, new okhttp3.Callback() {
            @Override
